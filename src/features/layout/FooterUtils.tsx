...
export const FooterUtils = ({ user }: { user?: UserProfile | null }) => {
  ...
  return (
    <div className="container sticky bottom-0 left-0 right-0 z-50 flex justify-between flex-1 max-w-2xl gap-1 py-2 m-auto border-t bg-background border-accent">
      <Button
        variant={"ghost"}
        className="flex-1"
        onClick={() => {
